INSERT INTO `phpcms_module` (`module`, `name`, `url`, `iscore`, `version`, `description`, `setting`, `listorder`, `disabled`, `installdate`, `updatedate`) VALUES ('addlinkagechina', '添加联动菜单-中国省份', '', '1', '1.0', '', '', '0', '0', '2016-7-24', '2016-7-24');
